![IMAGE](https://raw.githubusercontent.com/nogi-bot/resources/main/jeygeon/images/720cebb8-597a-4f8c-937f-189991e47dea-image.png)  
...
## 📌 ORM<br>  
---  
`ORM`은 데이터베이스와 객체를 매핑 해주는 기술이다. DB의 테이블과 객체가 매핑 되어 SQL문을 일일이 작성하지 않고 객체로 구현이 가능한 기술이다.  
...
물론 `ORM`에서도 직접 쿼리를 작성할 수 있는 대안이 있기 때문에 단점이 어느 정도 커버는 가능하다.  
