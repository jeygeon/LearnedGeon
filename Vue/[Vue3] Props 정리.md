...
![IMAGE](https://raw.githubusercontent.com/nogi-bot/resources/main/jeygeon/images/0e167cf8-7cf3-4515-aa21-59e1d568ad7b-image.png)  
  
`TheView.vue` 라는 부모 컴포넌트에서 각각의 `AppCard.vue` 라는 자식 컴포넌트로 데이터를 전달하는 상황을 가정해보자  
  
`props` 를 전달하는 방식은 여러가지가 있다.  
  
## 1️⃣ 부모 컴포넌트 ( TheView.vue )<br>  
---  
### 1. 정적 데이터 전달<br>  
```html  
<script setup>
